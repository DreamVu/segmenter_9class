...
def main(
    ...
    if resume and checkpoint_path.exists():
        ...
        checkpoint["model"]["decoder.cls_emb"]=torch.randn(1, 9,checkpoint["model"]["decoder.cls_emb"].shape[2])
        checkpoint["model"]["decoder.mask_norm.weight"] =torch.randn(9)
        checkpoint["model"]["decoder.mask_norm.bias"]=torch.randn(9)
    ...
    # train
    start_epoch = 1#variant["algorithm_kwargs"]["start_epoch"]
    num_epochs = 32#variant["algorithm_kwargs"]["num_epochs"]
    eval_freq = 1#variant["algorithm_kwargs"]["eval_freq"]
